    ...
    <AppLayout>
      <Box bg="white" p={4} rounded="md" shadow="md">
        ...
        <form onSubmit={formik.handleSubmit}>
          <FormControl id="english_word" mb="4" isInvalid={!!formik.errors?.english_word}>
            <FormLabel>English Word</FormLabel>
            <Input type="text" name="english_word" value={formik.values?.english_word} onChange={formik.handleChange} />
            {formik.errors.english_word && <FormErrorMessage>{formik.errors?.english_word}</FormErrorMessage>}
          </FormControl>
